...
import static Useful.DateFunctions.customDates;
...
public class GUI_CreerPersonne extends CustomJFrame {
    ...
    public GUI_CreerPersonne(Ecole ecole, String type) {
        ...
        fieldDate.setSettings(customDates());
    ...
    private String Date() {
        return fieldDate.getDate().toString();
    }
    ...
    private String Promotion() {
        return fieldPromotion.getText();
    }

    private String MatiereNom() {
        return fieldMatiereNom.getText();
    }

    private String MatiereID() {
        return fieldMatiereID.getText();
    }
    ...
    private void creerEleve() {
        ...
        Promotion p = ecole.getPromo(Promotion());
        if (p == null) {
