...
public class GUI_modifierNote extends CustomJFrame
{
    ...
    public GUI_modifierNote(Professeur prof, School ecole)
    {
    ...
    /**
     * Met à jour le Dropdown contenant la liste des {@link Promotion}
     * Si vide, affiche un message d'erreur ; sinon, appelle la fonction setID
     */
    ...
    /**
     * Met à jour le Dropdown contenant la liste des ID des {@link Eleve} contenus dans la {@link Promotion}
     * Si vide, affiche un message d'erreur ; sinon, appelle la fonction setIDNote
     */
    private void setID()
    {
    ...
    /**
     * Met à jour le Dropdown contenant la liste des ID et des notes de {@link Eleve}
     * selon la {@link Matiere} du {@link Professeur} connecté.
    ...
    /**
     * Si la note entrée est correcte, appelle la fonction permettant d'ajouter / de modifier une note
     * chez l'{@link Eleve} connecté
     */
